...
// Retorna undefined quando não encontra nenhum elemento
...
//every(): retorna true em caso TODOS os elementos correspondam ao critério
// ou false caso contrário
...
// cosrrespondem ao critério passado
 ...
 */
 ...
 // Abordagem 1: riando um vetor auxiliar contendo apenas os pesos dos pets
...
//Includes(): retorna true no caso o vetor inclua o valor informado
console.log(numeros.includes(6))
console.log(numeros.includes(11))

//Diferença de some() E includes()
//some() -> recebe uma função para testar a existeência de uma condição
